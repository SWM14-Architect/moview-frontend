...
function firstSection(){
  return (
    <div style={{width: "100%", textAlign:"center"}}>
      ...
      <img src={MainImage} alt="main" style={{width:"100%", marginTop:"2em"}} />
...
function secondSection(){
  ...
  const featureComponent = (title, description) => {
    return (
      <div className={`layout-flex-row-item ${style.feature_box}`}>
  ...
  return (
    <div>
      <section style={{backgroundColor:"#f4f7fb"}}>
        <div className={`container fadeInUpEffect`} style={{flexDirection:"column"}}>
          {firstSection()}
        </div>
      </section>
